...
public class Bomber extends Character {
    ...
    public boolean canMove(double x, double y) {
        x = x + 1;
        y = y - 1;
        double size = Game.TILES_SIZE * 3 / 4 - 2;
        int[] hx = {0, 0, 1, 1};
        int[] hy = {0, -1, 0, -1};
        for(int i = 0; i < 4; ++i) {
            int u = Coordinates.pixelToTile(x + hx[i] * size),
                    v = Coordinates.pixelToTile(y + hy[i] * (Game.TILES_SIZE - 1));
            Entity entity = _board.getEntity(u, v, this);
            //System.out.println(entity.getClass().getName() + " " + entity.collide(this));
