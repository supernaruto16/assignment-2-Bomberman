...
public class Sprite {
	...
	//New1
	public static Sprite new1_left1 = new Sprite(16, 6, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite new1_left2 = new Sprite(16, 6, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite new1_left3 = new Sprite(16, 6, 7, SpriteSheet.tiles, 16, 16);

	public static Sprite new1_right1 = new Sprite(16, 7, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite new1_right2 = new Sprite(16, 7, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite new1_right3 = new Sprite(16, 7, 7, SpriteSheet.tiles, 16, 16);

	public static Sprite new1_dead = new Sprite(16, 6, 8, SpriteSheet.tiles, 16, 16);
